...
local gradeview = require 'hitmouse2/gradeview'
local global = require "hitmouse2/global"

local ui = {
	TEA_FILE = 'hitmouse2/xiaozhang.json',
	TEA_FILE_3_4 = 'hitmouse2/xiaozhang43.json',

	STU_FILE = 'hitmouse2/bishai.json',
	STU_FILE_3_4 = 'hitmouse2/bishai43.json',
